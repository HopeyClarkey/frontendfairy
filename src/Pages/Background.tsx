  ...
  return (
    <div className="background">
      ...
      <p>Previous work experience includes leadership roles in award-winning restaurant environments, along with recognition such as Zagat’s 30 Under 30 New Orleans (2015) and Imbibe Magazine’s “Imbibe 75” (2016) for work in cocktail beverage programs, with a focus on clear, hand-cut ice and frozen drinks.
        ...
        That background carries into development in a practical way, with attention to flow, pressure, and how small decisions shape the overall experience. The focus remains on building systems that are stable under real use, clear in structure, and reliable as they move from design into interaction.</p>
    </div>
  )
};